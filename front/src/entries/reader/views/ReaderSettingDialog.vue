              ...
              <v-card outlined width="100%" class="my-1">
                ...
                <v-card-text class="d-flex flex-column">
                  <div class="d-flex align-center">
                    ...
                    <v-switch
                      inset
                      v-model="lazySetting.isUploadMode"
                      :disabled="!isLogin"
                    />
                  </div>
                  <div>
                  ...
                  <div class="d-flex align-center">
                    ...
                    <v-switch
                      inset
                      v-model="lazySetting.isStrictMode"
                      :disabled="!isLogin"
                    />
                  </div>
                        ...
                        <div class="d-flex align-center">
                          ...
                          >
                            ...
                            <div class="text-truncate" style="max-width: 170px">
                              {{
                                toDisplayFileName(
                                  lazySetting.timer.sound[tug].customPath
                                ) || '未选择文件'
                              }}
                            </div>
                          </v-btn>
...
export default {
  ...
  watch: {
    'readerSetting.isStrictMode': {
      handler(isStrictMode) {
        this.$set(this.lazySetting, 'isStrictMode', isStrictMode)
      },
      immediate: false,
    },
    show: {
