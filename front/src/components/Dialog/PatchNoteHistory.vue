<template>
  <div>
    ...
    <v-alert color="secondary" outlined class="mt-4">
      <div class="d-flex align-center">
        <div class="text-h6">Version 1.1.9</div>
        <v-spacer />
        <div class="text-subtitle-1">更新时间: 2022/03/06 13:37</div>
      </div>
    </v-alert>
    <div class="text-h6 my-1">鱼糕桌面版</div>
    <ul>
    ...
    <ul>
      <li>尝试修复下载问题</li>
      <li>
        服务商自3/4日起添加了每日总下载量的限制，下载人数过多后会下载失败，若下载失败请尝试手动下载。手动下载地址与自动下载不同，因此不会受到下载量的限制。
      </li>
      <li>缩小了安装文件的大小。</li>
    </ul>
    <v-divider />
    ...
    <ul>
      ...
      <li>增加钓场多语言支持</li>
      <li>增加多语言备选语言支持，当仍未有新版本翻译时，可设置备用显示的语言</li>
      <li>鱼以及钓场的部分文本更新字体</li>
      <li>修复导出的一些问题</li>
      <li>更新贺图</li>
    </ul>
    <v-divider />
    ...
    <ul>
      ...
      <li>更新国际服、国服星芒节支持，根据区服切换的设置运用对应的节日日期进行计算。</li>
      <li>首页增加微博区域。</li>
    </ul>

    <v-alert border="top" colored-border type="info" class="mt-4">
      <div>
        星芒节期间三主城固定小雪，因此一些鱼的窗口期会受影响：<br />
        星芒节期间全勤奖普通鱼：求雨鱼<br />
        星芒节期间窗口期变长：招雨王<br />
        星芒节期间无窗口期：倔强鲫鱼、抽须王、枪鼻头、芳香蝾螈 (<s>我们放寒假了~</s>）
      </div>
    </v-alert>
    ...
    <ul>
      ...
      <li>增加中庸工艺馆任务鱼的提示。感谢 <strong>凛田莉子@红玉海</strong> 的测试！</li>
    ...
    <div class="text-h6 my-1">渔捞</div>
    <ul>
      <li>修复“鱼线断了！”判断为未知鱼的问题（上传的数据也已经修复）</li>
      <li>修复切换职业Buff状态没有清除的问题</li>
      <li>修复咬钩时间显示负值的问题（现在异常数据会显示为 0）</li>
    ...
    <ul>
      <li>
        增加
        <span class="font-weight-bold orange--text" style="font-size: x-large">
          数据统计图
        </span>
        ，前往钓鱼笔记中的钓场即可查看
      </li>
    ...
    <ul>
      <li>增加更新提示</li>
      <ul>
        <li>下次新版本更新会显示更新确认框</li>
        <li>在确认更新前将不会下载更新文件</li>
        <li>在更新确认框中显示新版本更新简介</li>
      </ul>
    </ul>
    ...
    <div class="text-h6 my-1">鱼糕桌面版</div>
    <ul>
      <li>修复上次动态加载界面后出现的一系列问题，现改为部分界面第一次打开时动态加载</li>
      <li>修复设置无法保存的问题（如鼠标穿透，仅钓鱼时候显示渔捞等等）</li>
    </ul>
    ...
    <ul>
      ...
      <li>增加咬钩提示文字</li>
      <li>增加鼠标穿透快捷键设置</li>
      <li>修复迷你模式计时器的位置记录问题</li>
      <li>再次修复幻海流计时器延长计算出错的问题</li>
    </ul>
    <p />
    ...
    <ul>
      ...
      <li>增加鱼眼变化后相关鱼攻略，感谢 梦洄子时@红玉海 的大力支持！</li>
      <li>
    ...
    <ul>
      ...
      <li>
        更新了 不朽巨鱼 的天气和咬钩 天气：从 阴云 修正为 晴朗/碧空 转 阴云/薄雾，补充了
        咬钩 为 鱼王竿。
      </li>
    </ul>
    <p />
