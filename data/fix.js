  ...
  OCEAN_FISHING_TIPS: {
    ...
    tip3: {
      ...
      fishTipDict: {
        // 索蒂斯
        29788: {
          content: '天堂之钥3s内可以自信双提，3.0、3.1为天堂之钥与海神印的重合区间，5s后可直接收杆<br />\n' +
            '火萤存在较长的中杆可能导致鱼识内仅能抛一杆，触发鱼识后可酌情拍水门票鱼'
        },
        // 珊瑚蝠鲼
        29789: {
          content: '门票最难的蓝鱼，高级以太药虱为3-5的轻杆，超过5s必为太阳神面纱，巨大枪鱼为3s内中杆，超过3s可直接断杆<br />\n' +
        ...
        // 依拉丝莫龙
        29791: {
          content: '门票为唯一鱼王杆，提就对了！但是注意杆型不要提错了<br />\n' +
            '在鱼识快结束的那杆(3s左右)如果是守领鳍龙可以选择稍微延后一点提钩直接双提，可以在鱼识结束后再次进鱼识<br />\n' +
            '重板铁钩存在长杆可能导致鱼识内仅能抛一杆，可以酌情考虑拍水门票鱼使鱼王杆不会歪门票鱼'
        },
        // 石骨鱼
        29790: {
          content: '沉寂者为大于3s的轻杆，深海鳗为长中杆(甚至能到9s+)，建议全提并酌情拍水<br />\n' +
            '沟鼠尾巴存在长杆可能导致鱼识内仅能抛一杆，请尽可能的拍掉触发鱼识的那个门票鱼来获取更高的抛两杆的概率'
        },
        // Hafgufa
        32074: {
          content: 'Mistbeard\'s Cup为3-5s的中杆，超过5s可直接断杆，Jetborne Manta3s内可自信双提，若门票只差这条可选择断杆'
        },
        // Seafaring Toad
        32094: {
          content: 'Beatific Vision可对3s内的中杆自信双提，蓝鱼如果开了耐心的话疑似是精准提'
        },
        // Placodus
        32114: {
          content: '我愿称之为最难蓝鱼，鱼识持续45s<br />\n' +
      ...
      extra: '强烈建议触发门票时用门票鱼的最优饵、鱼识内尽可能拍一杆增加鱼识质量，部分海域鱼识内第一杆可以使用撒饵来保证鱼识内可以跑出第二杆'
