  ...
  OCEAN_FISHING_TIPS: {
    ...
    tip3: {
      ...
      fishTipDict: {
        ...
        // 海洋蟾蜍
        32094: {
          content: '幸福愿景可对3s内的中杆自信双提，蓝鱼如果开了耐心的话疑似是精准提',
        },
        // 盾齿龙
        32114: {
          content:
      ...
      missionTip: {
        ...
        243:
          '种类任务：水母or螃蟹X7<br />\n' +
          '拉诺西亚水母，海荨麻[午]；剪碎手巴塞洛缪[夜]<br />\n' +
          '数量任务：！34，！！18，！！！6<br />\n' +
          '！拉诺西亚水母、蓬松海龙(阴云薄雾不出现)，海荨麻[午]；灵敏舞者、钉牡蛎[日]；珊瑚海龙[午]、剪碎手巴塞洛缪[夜]<br />\n' +
          '！！青色章鱼，人鱼发、幽灵鲨；幻纱披风[夜]<br />\n' +
          '！！！莫莫拉·莫拉(单)，无赖龙(单)[午]；暗淡鲨(单)(暴雨不出现)，漏斗鲨[午]；守领鳍龙<br />\n',
        241:
          '种类任务：鲨鱼X5<br />\n' +
          '幽灵鲨，漏斗鲨[午]；铬铁锤头鲨，处刑者[日]<br />\n' +
          '数量任务：！34，！！11，！！！13<br />\n' +
          '！灵敏舞者、钉牡蛎[日]；拉诺西亚水母、蓬松海龙(阴云薄雾不出现)，海荨麻[午]；沉寂者，浮游碟鱼[夜]<br />\n' +
          '！！青色章鱼，人鱼发、幽灵鲨<br />\n' +
      ...
      pointTip: {
        ...
        250: {
          0: {
            ...
            tipContent:
              '石沙蚕，3s-！，鱼酱罐(双4)；鳞虾，5-6s！！，珍珠爆弹(双4)；刺螠，3s+！！，潘诺普忒斯(双4)<br />\n' +
              '常驻高分鱼，鳞虾，6s+！！，刀颚鱼(双2)',
          },
          1: {
